...
#include <package_name/Node2NameConfig.h>
...
class Node2Name {
    ...
    private:
        ...
        // Dynamic reconfigure
        dynamic_reconfigure::Server<package_name::Node2NameConfig> server;
        dynamic_reconfigure::Server<package_name::Node2NameConfig>::CallbackType f;
        ...
        void callbackParameters(package_name::Node2NameConfig &config, uint32_t level);
